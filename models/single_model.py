...
class SingleModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        self.netG_A = networks.define_G(self.opt,retina=self.opt.retina)
        self.netG_A.cuda()
    ...
    def get_current_visuals(self):
        ...
        if self.opt.skip > 0:
            latent_fake_A = util.tensor2im(self.latent_fake_A1.data)
            return OrderedDict(
                [('under', under), ('over', over), ('gt', gt), ('a1', a1), ('a2', a2), ('fake_A', fake_A),
                 #('fake_B', fake_B),
                 ('fake_C', fake_C),

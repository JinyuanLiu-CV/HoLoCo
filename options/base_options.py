...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--n_layers_patchD', type=int,
        ...
        self.parser.add_argument(
            '--vgg', type=float, default=0, help='use perceptrual loss')
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            '--patchD', action='store_true', help='use patch discriminator')
        self.parser.add_argument('--patchD_3', type=int, default=0,
                                 help='choose the number of crop for patch discriminator')
        self.parser.add_argument('--hasglobal', type=int, default=0,
                                 help='666')
        self.parser.add_argument(
    ...
    def parse(self):
        ...
        # save to the disk
        expr_dir = './datasets/checkpoints/enlightening'
